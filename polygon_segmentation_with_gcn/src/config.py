...
class ModelConfiguration:
    ...
    CONNECTION_THRESHOLD = 0.88

    NEGATIVE_SAMPLE_MULTIPLIER = 1
    POSITIVE_SAMPLE_MULTIPLIER = 5

    NUM_ENCODER_LAYERS = 4
    NUM_DECODER_LAYERS = 4
    NUM_PREDICTOR_LAYERS = 2

    EDGES_BUFFER_DISTANCE = 1e-4
    LINESTRING_REDUCTION_LENGTH = 1e-3
    POLYGON_EXTERIOR_BUFFER_DISTANCE = 1e-6

    BCE_LOSS_WEIGHT = 1.0
    CROSS_ENTROPY_LOSS_WEIGHT = [1.0, 1.0, 0.2]
